        ...
        if ($role) {
            ...
            if ($role == 'administrateur') {
                ...
                $validator = Validator::make($request->all(), [
                    ...
                    'login' => 'required|unique:utilisateurs|max:100|regex:/[^0-9.-/_]/',
                    'password' => 'required|unique:utilisateurs',
                    'email' => 'required|email|unique:utilisateurs',
                    'role' => 'required|max:50',
                    'photo' => 'required|unique:utilisateurs',
                    'actif' => 'required',
                    'nomAdministrateur' => 'required|max:100|regex:/[^0-9.-/_]/',
                    'prenomAdministrateur' => 'required|max:100|regex:/[^0-9.-/_]/',
